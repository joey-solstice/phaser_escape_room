...
export class BackStoryScene extends Phaser.Scene {
    
    

    constructor(data) {
        super({ key: CST.SCENES.BACKSTORY })  
    }   
    ...
    displayAssets() { 
        const roomNumber = this.data.room ? this.data.room : 'backstory-room-' + 1;
    ...
    closePage()
    { 
        this.scene.stop(CST.SCENES.BACKSTORY)  
    } 
}
